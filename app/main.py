...
def debug_create_position():
    ...
    if raw_price is None:
        return jsonify({"status": "error", "message": "Missing price/current_price"}), 400
    ...
    telegram_data = {
        ...
        "risk_levels": {
            "entry_price": price,
            "stop_loss": position_data.get("sl_level", 0),
            "take_profit_1": position_data.get("tp_levels", {}).get("TP1", 0),
            "take_profit_2": position_data.get("tp_levels", {}).get("TP2", 0),
            "take_profit_3": position_data.get("tp_levels", {}).get("TP3", 0),
        },
        "signal_strength": 100,
    }
